  ...
  return (
    <>
      <section className="max-w-4xl mx-auto px-6 py-12 text-gray-800 h-full w-full">
        ...
        <p className="mb-4">
          You may cancel your booking up to 24 hours in advance. Late
        ...
        <p className="mb-4">
          By clicking "Submit", you agree to the above terms and confirm that
          all details provided are correct to the best of your knowledge.
        </p>
